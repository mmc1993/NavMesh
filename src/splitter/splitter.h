...
template<class T>
inline void Splitter::RemoveFromVector(std::vector<T>& container, const T & value)
{
...
template<class T, class Pred>
inline void Splitter::RemoveFromVector(std::vector<T>& container, const Pred & pred)
{
	container.erase(std::remove_if(container.begin(), container.end(), pred), container.end());
}

template<class T>
inline void Splitter::AppendToVector(std::vector<T>& container, const T & value)
{
